...
import com.example.Meetstranger.util.AppRTCUtils;
...
public class AppRTCAudioManager {
    ...
    // selection scheme.
    // TOD: always set to AudioDevice.NONE today. Add support for
    ...
    // TOD: audioManager.requestAudioFocus() is deprecated.
    public void start(AudioManagerEvents audioManagerEvents) {
        ...
        // TOD: perhaps call new method called preInitAudio() here if UNINITIALIZED.
        ...
        audioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
            ...
            // TOD: possibly extend support of handling audio-focus changes. Only contains
            // logging for now.
            @Override
    ...
    @SuppressWarnings("deprecation")
    // TOD(henrika): audioManager.abandonAudioFocus() is deprecated.
    public void stop() {
        Log.d(TAG, "stop");
        ThreadUtils.checkIsOnMainThread();
        if (amState != AudioManagerState.RUNNING) {
     ...
     * TOD: add usage of this method in the AppRTCMobile client.
     */
     ...
     * TOD: add unit test to verify all state transitions.
     */
    public void updateAudioDeviceState() {
        ...
        // change accordingly.
        // TOD: perhaps wrap required state into BT manager.
