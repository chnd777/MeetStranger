...
public class MainActivityMale extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adListener = new AdListener() {
            ...
            public void onAdClicked(Ad ad) {
                adscount++;
                PersistentUser.setAdsCount(MainActivityMale.this,adscount);
            }
        ...
        findViewById(R.id.share_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                */
                String reportString = PersistentUser.getLastCallerId(MainActivityMale.this);
        ...
        findViewById(R.id.more).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isInternetAvailable()){
                    ...
                    Intent intent = new Intent(MainActivityMale.this,MoreActivity.class);
                    startActivity(intent);
                }
                //
            }
    ...
    public void onBackPressed() {
        if (!isSearching) {
            new AlertDialog.Builder(this)
                    .setTitle("Are you sure closing this app?")
                    .setMessage("Thanks for using our service")
                    .setNegativeButton(android.R.string.no, null)
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface arg0, int arg1) {
                            MainActivityMale.super.onBackPressed();
                        }
                    }).create().show();
        }else {
            connectCall();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_MIC) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(MainActivityMale.this,"Premission Granted",Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(MainActivityMale.this,"Premission Failed",Toast.LENGTH_SHORT).show();
            }
        }
        if (requestCode == REQUEST_CALL) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(MainActivityMale.this,"Premission call Granted",Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(MainActivityMale.this,"Premission call Failed",Toast.LENGTH_SHORT).show();
            }
        }
...
//                                   }
    ...
    private void connectToRoom(String roomId, boolean commandLineRun, boolean loopback,
        ...
        MainActivityMale.commandLineRun = commandLineRun;
...
//        boolean useCamera2=false;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.action_profile){
            Intent intent = new Intent(MainActivityMale.this, ProfileActivity.class);
            startActivity(intent);
            return true;
        }
        if(id==R.id.action_instagram){
            ...
            Uri uri = Uri.parse("market://details?id=" + MainActivityMale.this.getPackageName());
            ...
            try {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://play.google.com/store/apps/details?id=" + MainActivityMale.this.getPackageName())));
            }
            return true;
